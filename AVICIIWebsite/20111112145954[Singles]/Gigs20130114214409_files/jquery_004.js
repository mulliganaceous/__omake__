...
$(document).ready(function(){
	...
	$('body.avicii-tv .clip-container').click(function(e){
		...
		container.html('<iframe width="280" height="210" src="http://web.archive.org/web/20130115011302/http://www.youtube.com/embed/' + youtubeId + '?autoplay=1" frameborder="0" autoplay allowfullscreen></iframe>')
	});
	// GIGS
		...
		$('body.gigs #gig-list li a').click(function(e){
			...
			$.ajax({
				...
				success: function(data){
					...
					var script = 'http://web.archive.org/web/20130115011302/http://s7.addthis.com/js/250/addthis_widget.js#domready=1';
					if (window.addthis){
					    window.addthis = null;
					}
					$.getScript( script );
...
/*
     FILE ARCHIVED ON 01:13:02 Jan 15, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 03:25:50 Jan 12, 2021.
...
/*
playback timings (ms):
  PetaboxLoader3.resolve: 53.158 (2)
  load_resource: 94.989
  captures_list: 90.878
  LoadShardBlock: 69.266 (3)
  esindex: 0.013
  RedisCDXSource: 0.649
  exclusion.robots.policy: 0.155
  CDXLines.iter: 17.71 (3)
  exclusion.robots: 0.168
  PetaboxLoader3.datanode: 79.945 (4)
*/